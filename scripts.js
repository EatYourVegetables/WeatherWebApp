function getWeatherByCity(){
    let url = 'http://api.openweathermap.org/data/2.5/forecast?zip=75070,us&APPID=66177b9f8e05e1e2fccf8a3518573f0a';
    ...
    .then(data => {
        ...
        let city = data.city;
        let temp = k2f(weather.temp);

        document.getElementById("temp").innerHTML = temp + '<span>°F</span>';
        console.log(temp);
...
function getWeatherHourly(){
    let url = 'http://api.openweathermap.org/data/2.5/forecast?id=4684888&APPID=66177b9f8e05e1e2fccf8a3518573f0a';
